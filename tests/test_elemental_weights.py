...
class ParseTests(unittest.TestCase):
    def test_a_bare_number_is_a_base_with_no_rules(self):
        from merge_studio.elemental_weights import parse_weight_spec
...
class ResolveTests(unittest.TestCase):
    def test_a_module_no_rule_matches_gets_the_base(self):
        from merge_studio.elemental_weights import parse_weight_spec, resolve_weight
...
class OverlapTests(unittest.TestCase):
    def test_overlapping_rules_are_reported(self):
        from merge_studio.elemental_weights import overlaps, parse_weight_spec
...
class ProfileTests(unittest.TestCase):
    def test_the_profile_has_one_row_per_target(self):
        from merge_studio.elemental_weights import parse_weight_spec, weight_profile
...
class ProfileHtmlTests(unittest.TestCase):
    def test_the_targets_are_listed(self):
        from merge_studio.elemental_weights import format_weight_profile_html, parse_weight_spec
...
class WritingSideTests(unittest.TestCase):
    ...
    def test_a_text_of_rules_alone_leaves_the_base_to_the_slider(self):
        from merge_studio.elemental_weights import parse_weight_spec, spec_with_base
...
L15-L27:mlp.b:0.5"""
    ...
    def test_the_resolved_weights_follow_the_rule_and_the_base_elsewhere(self):
        from merge_studio.elemental_weights import parse_weight_spec, resolve_weight, spec_with_base
...
class ValidationTests(unittest.TestCase):
    ...
    def test_a_rule_entirely_past_the_end_is_reported(self):
        from merge_studio.elemental_weights import parse_weight_spec, validate_spec
...
class EditorHtmlTests(unittest.TestCase):
    def test_no_model_selected_asks_for_one(self):
        from merge_studio.elemental_weights import format_weight_editor_html, parse_weight_spec
    ...
    def test_problems_are_shown_above_the_profile(self):
        from merge_studio.elemental_weights import (
...
class BlockArrayTests(unittest.TestCase):
    ...
    def test_the_tail_past_the_diffusion_blocks_is_split_off(self):
        from merge_studio.elemental_weights import split_block_array
    ...
    def test_the_arrays_the_library_actually_contains_are_constant(self):
        from merge_studio.elemental_weights import is_constant
    ...
    def test_a_constant_array_is_not_drawn_at_all(self):
        ...
        from merge_studio.elemental_weights import format_block_array_html
